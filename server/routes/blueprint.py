...
from controllers.app_controller import get_specie_info, get_species_available_models, predict_species_with_model, \
...
blueprint.route('/birds/<string:species_name>', methods=['GET'])(get_specie_info)
